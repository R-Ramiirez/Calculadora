...
<body>
    <div class="container mt-4">
        <div class="row justify-content-center">
            <h1 class="text-center m-4 mt-5 fs-2 fs-md-1">Simulador de Puntajes UMAG</h1>
            <br>
            <h5 class="w-100 w-md-75 text-center fs-6 fs-md-5">Aquí podrás simular tus puntajes de ingreso a la Universidad de Magallanes para el proceso de admisión 2024. Ingresa tus puntajes de la PAES en los casilleros correspondientes (recuerda considerar un número entre 100 y 1000).</h5>
